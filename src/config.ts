...
import { ICharacterTrainerServiceConfig, ServiceConfig, ServicePorts } from './types/characterTrainerTypes';

export class CharacterTrainerServiceConfig implements ICharacterTrainerServiceConfig {
